...
<body>
    ...
    <h2>Enteros</h2>
    <p>Números enteros en PHP son de 32 bits (depende de la plataforma). 
        Pueden expresarse en diferente notaciones.</p>
    <?php
        $numero_entero = 1234;
        ...
        $numero_hex = 0xBAE;
        echo "El número 0xBAE en hexadecimal es en decimal: $numero_hex";

        // Un número entero en binario.
        echo "El número $numero_hex en hexadecimal es " . dechex($numero_hex) . "<br>";

        // Un número entero en binario
        $numero_binario = 0b11010110;
        echo "El número 11010110 es en decimal: $numero_binario<br>";

        // Mostrar un número expresado en binario
        echo "EL número $numero_binario en binario es " . decbin($numero_binario) . "<br>";
    ?>

    <h2>Números en punto</h2>
    <p>El separador decimal es el punto . y se pueden expresar números muy grandes y 
        muy pequeños mediante la notación científica con base 10 </p>
    ...
    <p>Un string o cadena es una serie de caracteres donde cada carácter equivale a un byte.
        Esto significa que PHP solo admite 256 caracteres y por ello no ofrece soporte
    ...
    <?php
        ...
        no acaba hasta el punto y coma<br>";
        ...
        echo "Esta cadena tiene más de una línea<br>";
    ...
    <p>La forma habitual de expresar cadenas de caracteres ya que expande los 
        caracteres de escape y las variables.</p>
    <?php
        ...
        lo quieres en una cadena hay que escaparlo con \\. Es mejor usar \" para delimitar
        las cadenas en lugar de '<br>";
    ...
    después un salto de línea. A continuación se escribe la cadena, con los saltos de 
    línea que necesitemos, podemos interpolar variables y poner caracteres de escape. 
    ...
    <p>La cadena Nowdoc es como Heredoc con comillas simples. No se interpolan 
        variables ni se reconocen secuencias de escape más alla de \ y '. 
        No se respetan los saltos de líneas</p>
    <?php
        $cadena_nd = <<<'ND'
    ...
    <p>Conversiones explícitas se conocen como casting o moldeo y se hacen
        procediendo la expresión con el tipo de datos a convertir entre paréntesis.
    </p>
    <?php
